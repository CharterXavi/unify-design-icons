...
const SearchIcon = (props) => {
    return (
        <svg className={props.className} width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M32.7151 15.3448C32.7151 20.3556 28.7203 24.3966 23.8182 24.3966C18.9162 24.3966 14.9214 20.3556 14.9214 15.3448C14.9214 10.334 18.9162 6.2931 23.8182 6.2931C28.7203 6.2931 32.7151 10.334 32.7151 15.3448Z" fill="url(#search1)" stroke="#282E3E" strokeWidth="1.55172"/>
